...
But I keep thinking: what if this is just the first step? What if, instead of helping us write code, AI could become the system that runs our intent directly?
