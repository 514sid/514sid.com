...
Lately I've been thinking about how we're using AI in software development, and I've started to wonder what new possibilities might emerge beyond the current trends.

Right now, the focus is largely on using AI to help developers write code faster — generating functions, scaffolding boilerplate, suggesting implementations. It's like having a smart assistant in your IDE, and that's genuinely useful.

But what if this is only the beginning? What if, instead of just assisting with writing code, AI could take on the role of executing our intentions directly?

## From writing code to describing behavior

Almost all programming involves input, processing, and output. Something happens, we handle it, and then respond in some way.
